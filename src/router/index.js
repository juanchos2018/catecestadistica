...
let routes = [{
    ...
    },
    {
        ...
        layout: "dashboard",
        component: () =>
            import ('../views/Estudiante/EstudianteList.vue'),
    },
    {
        path: '/estudiantesadd',
        name: 'EstudiantesAdd',
        layout: "dashboard",
        component: () =>
            import ('../views/Estudiante/EstudianteAdd.vue'),
    },
    {
        path: '/eventodiaslist',
        name: 'EventoDiasList',
        layout: "dashboard",
        component: () =>
            import ('../views/Evento/EventoList.vue'),
    },
    {
        path: '/eventoasistencia/:datos',
        name: 'EventoAsistencia',
        layout: "dashboard",
        props: true,
        component: () =>
            import ('../views/Evento/EventoAsistencia.vue'),
    },

    {
        path: '/ponentelist/:id_evento',
        name: 'PonenteList',
        layout: "dashboard",
        props: true,
        component: () =>
            import ('../views/Evento/EventoPonenteList.vue'),
    },

    {
        path: '/ponenteadd/:id_evento',
        name: 'PonenteAdd',
        layout: "dashboard",
        props: true,
        component: () =>
            import ('../views/Evento/EventoPonenteAdd.vue'),
    },
    {
        path: '/eventoponente/:id_evento',
        name: 'EventoPonente',
        layout: "dashboard",
        props: true,
        component: () =>
            import ('../views/Evento/EventoPonente.vue'),
    },

    {
        path: '/eventoasistidos/:datos',
    ...
    {
        path: '/temaevento/:id_evento',
        name: 'TemasEvento',
        layout: "dashboard",
        props: true,
        component: () =>
            import ('../views/Evento/EventoTema.vue'),
    },
