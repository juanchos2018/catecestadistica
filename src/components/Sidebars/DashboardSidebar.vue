<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-ct-black.png" alt=""> <span>Inicio</span></div>
			<hr>
			...
			<a-menu-item >
					<router-link to="/prueba">
						...
						<span class="label">Por Dominio</span>
					</router-link>
				</a-menu-item>		
