  ...
  <div>
    ...
    <a-row :gutter="24" type="flex">
      ...
      <a-col :span="24" class="mb-24">
        <a-button type="primary" @click="AddPonente">
          AGREGAR PONENTE
        </a-button>
      
        <!-- Authors Table Card -->
        <TablaPonentes :data="itemEstudens" :columns="Cabecera" v-on:Eliminar="Delete"></TablaPonentes>
      </a-col>
    </a-row>
    <!-- / Authors Table -->
  </div>
...
import TablaPonentes from "@/components/Tablas/TablaPonentes";
...
export default {
  ...
  methods: {
    AddPonente() {
      ...
      ///this.$router.push({ name: "PonenteAdd" });
          this.$router.push({
              name: "PonenteAdd",
              params: { id_evento: this.id_evento},
        });
    },
    PonenteList() {
      let me = this;     
